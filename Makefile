...
define Build/Compile
	...
	[ -f $(PKG_BUILD_DIR)/v2ray_armv7 ] && mv $(PKG_BUILD_DIR)/v2ray_armv7 $(PKG_BUILD_DIR)/v2ray
	[ -f $(PKG_BUILD_DIR)/v2ctl_armv7 ] && mv $(PKG_BUILD_DIR)/v2ctl_armv7 $(PKG_BUILD_DIR)/v2ctl
endef
